 ...
 */
export interface IServerIntegrationServerConfig {
  apiKey?: string;
 ...
 */
export class ServerIntegrationServer extends MCPServerBase {
   ...
   */
  constructor(config: IServerIntegrationServerConfig) {
